...
<div class="box">
    <div class="box-header">
      <h3 class="box-title"> اكسسوار</h3>
      <a href="{{ route('admin-accessories.create') }}" class="btn btn-info btn-lg pull-right"> اضافة </a>
						...
						@foreach($rows as $index => $row)
							<tr>
                                ...
                                <td>{!! $row->overview !!} </td>
                                      ...
                                      <td>
                                        <div class="btn-group">
                                            ...
                                            <a href="{{ route('admin-accessories.edit', $row->id) }}">
                             ...
                             <div class="modal modal-danger" id="del{{ $row->id }}" tabindex="-1" role="dialog"
                                ...
                                <form action="{{ route('admin-accessories.destroy', $row->id) }}"  method="POST" >
                                    @csrf
                                    @method('DELETE')
