    ...
    @foreach ($blogs as $blog)
        <div class="col-lg-12  mb-4">
            <div class="text-right box-shadow">
                <p>
                    <img src="{{ asset('public/public/uploads/blogs') }}/{{ $blog->image }}"
                        alt="{{ asset('public/public/uploads/blogs') }}/{{ $blog->image }}" style="height: 350px !important" class="img-fluid  w-100">
                </p>
                <div class="p-3">
